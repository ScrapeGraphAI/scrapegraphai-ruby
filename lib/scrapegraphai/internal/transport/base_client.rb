  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Scrapegraphai::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Scrapegraphai::Internal::Util.os,
            "x-stainless-package-version" => Scrapegraphai::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Scrapegraphai::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Scrapegraphai::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Scrapegraphai::Internal::Util.uri_origin(url) != Scrapegraphai::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Scrapegraphai::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Scrapegraphai::Errors::APIConnectionError | (500..)
              Scrapegraphai::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Scrapegraphai::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Scrapegraphai::Internal::Transport::PooledNetRequester.new
          @headers = Scrapegraphai::Internal::Util.normalized_headers(
          ...
          @base_url_components = Scrapegraphai::Internal::Util.parse_uri(base_url)
          @base_url = Scrapegraphai::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<Scrapegraphai::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Scrapegraphai::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Scrapegraphai::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Scrapegraphai::Internal::Util.interpolate_path(uninterpolated_path)

          query = Scrapegraphai::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              Scrapegraphai::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = Scrapegraphai::Internal::Util.join_parsed_uri(
            @base_url_components,
            {**req, path: path, query: query}
          )
          headers, encoded = Scrapegraphai::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [Scrapegraphai::Errors::APIError]
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in (400..) | Scrapegraphai::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Scrapegraphai::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<Scrapegraphai::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Scrapegraphai::Internal::Type::BaseStream>, nil]
        #
        # @param model [Scrapegraphai::Internal::Type::Converter, Class, nil]
        #
        # @param options [Scrapegraphai::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Scrapegraphai::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Scrapegraphai::RequestOptions.validate!(opts)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Scrapegraphai::Internal::Type::BasePage[Scrapegraphai::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(Scrapegraphai::Internal::Type::Converter::Input),
              options: T.nilable(Scrapegraphai::RequestOptions::OrHash)
            }
          end
        end
