...
module Scrapegraphai
  module Internal
    module Type
      ...
      # `Scrapegraphai::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Scrapegraphai::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Scrapegraphai::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in Scrapegraphai::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
            else
            end
