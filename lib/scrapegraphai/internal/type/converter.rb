    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Scrapegraphai::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Scrapegraphai::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Scrapegraphai::FilePart.new(value)
          in Scrapegraphai::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Scrapegraphai::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Scrapegraphai::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Scrapegraphai::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Scrapegraphai::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Scrapegraphai::Internal::Type::Converter
              ...
              Scrapegraphai::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Scrapegraphai::Internal::Type::Converter, T::Class[T.anything]) }
        end
