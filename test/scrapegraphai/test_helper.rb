...
class Scrapegraphai::Test::SingletonClient < Scrapegraphai::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Scrapegraphai::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Scrapegraphai::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @scrapegraphai = Scrapegraphai::Test::SingletonClient.instance
  end
