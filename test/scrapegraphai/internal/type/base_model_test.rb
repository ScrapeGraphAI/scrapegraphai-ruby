...
class Scrapegraphai::Test::PrimitiveModelTest < Minitest::Test
  A = Scrapegraphai::Internal::Type::ArrayOf[-> { Integer }]
  H = Scrapegraphai::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Scrapegraphai::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Scrapegraphai::Internal::Type::Unknown,
      Scrapegraphai::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Scrapegraphai::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Scrapegraphai::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Scrapegraphai::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Scrapegraphai::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Scrapegraphai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Scrapegraphai::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Scrapegraphai::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Scrapegraphai::Internal::Type::Boolean, true] => true,
      [Scrapegraphai::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Scrapegraphai::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Scrapegraphai::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Scrapegraphai::Internal::Type::Converter.new_coerce_state
      Scrapegraphai::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Scrapegraphai::Internal::Type::Converter.dump(target, input, state: state)
...
class Scrapegraphai::Test::CollectionModelTest < Minitest::Test
  A1 = Scrapegraphai::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Scrapegraphai::Internal::Type::HashOf[Integer]

  A2 = Scrapegraphai::Internal::Type::ArrayOf[H1]
  H2 = Scrapegraphai::Internal::Type::HashOf[-> { A1 }]

  A3 = Scrapegraphai::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Scrapegraphai::Internal::Type::HashOf[Integer, nil?: true]
...
class Scrapegraphai::Test::BaseModelTest < Minitest::Test
  class M1 < Scrapegraphai::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Scrapegraphai::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Scrapegraphai::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Scrapegraphai::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Scrapegraphai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Scrapegraphai::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Scrapegraphai::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Scrapegraphai::Errors::ConversionError => e
...
class Scrapegraphai::Test::UnionTest < Minitest::Test
  class U0
    include Scrapegraphai::Internal::Type::Union
  ...
  class M2 < Scrapegraphai::Internal::Type::BaseModel
  ...
  class M4 < Scrapegraphai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Scrapegraphai::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Scrapegraphai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Scrapegraphai::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Scrapegraphai::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      [Scrapegraphai::Internal::Type::Unknown, Scrapegraphai::Internal::Type::Unknown] => true,
      [Scrapegraphai::Internal::Type::Boolean, Scrapegraphai::Internal::Type::Boolean] => true,
      [Scrapegraphai::Internal::Type::Unknown, Scrapegraphai::Internal::Type::Boolean] => false,
...
class Scrapegraphai::Test::MetaInfoTest < Minitest::Test
  A1 = Scrapegraphai::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Scrapegraphai::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
