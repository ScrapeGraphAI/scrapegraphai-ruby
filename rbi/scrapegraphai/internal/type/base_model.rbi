    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Scrapegraphai::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
                        Scrapegraphai::Internal::Type::Converter::Input
                      )
                  }
                )
              ]
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Scrapegraphai::Internal::Type::BaseModel::KnownField,
                  { type: Scrapegraphai::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            params(
              ...
              spec: Scrapegraphai::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: Scrapegraphai::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Scrapegraphai::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Scrapegraphai::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Scrapegraphai::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Scrapegraphai::Internal::AnyHash) }
        def to_h
        end
